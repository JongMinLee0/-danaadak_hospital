...
function html5Upload() {
	...
	sUploadURL = '/hos/comm/smartPhoto'; // upload
																				// URL
	// 파일을 하나씩 보내고, 결과를 받음.
...
function callFileUploader() {
	oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"), {
		...
		// //사진을 업로드할 URL 경로
		sUrl : '/hos/comm/smartPhoto',
		sCallBack : '/hos/resources/smartEditor/photo_uploader/popup/callback.html', //절대경로 
